...
def lidar(laser):
    ...
    #if 
    #q=aruco.markers[1].pose.pose.position.z
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/simple_scan", LaserScan , lidar)
    rospy.Subscriber("/aruco_marker_publisher/markers", MarkerArray , aruco)
    ...
    #ts = message_filters.ApproximateTimeSynchronizer([laser_sub, aruco_sub], 10, 0.1, allow_headerless=True)
